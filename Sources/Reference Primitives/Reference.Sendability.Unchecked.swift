...
extension Reference.Sendability {
    ...
    // concrete stored-property set the checker can prove Sendable — this is
    // the auditable escape hatch itself, not a compiler-limitation
    // workaround, so no revalidation anchor applies.
