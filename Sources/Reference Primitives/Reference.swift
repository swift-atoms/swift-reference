...
///
/// Non-owning reference types for relationship modeling. These types refer to
/// objects without owning them—they do not participate in ownership or lifetime
/// management of the referenced objects.
///
/// ## Types
///
